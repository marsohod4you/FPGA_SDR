...
alias com {
  ...
  vcom "$QSYS_SIMDIR/mfir_rtl.vhd"                                   
  vcom "$QSYS_SIMDIR/mfir_ast.vhd"                                   
  vcom "$QSYS_SIMDIR/mfir.vhd"                                       
  vcom "$QSYS_SIMDIR/mfir_tb.vhd"                                    
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS -L work -L work_lib -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiii_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneiii $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiii_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneiii $TOP_LEVEL_NAME
}
