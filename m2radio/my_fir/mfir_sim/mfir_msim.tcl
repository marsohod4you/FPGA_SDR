...
if {[string match $flow "rtl"] } {
    ...
    if {[file exists mfir.vhd]} {vcom -93 -work work mfir.vhd}
    if {[file exists mfir.v]} {vlog -work work mfir.v}
    vcom -93 -work work mfir_ast.vhd
    vcom -93 -work work mfir_rtl.vhd
