...
% file : mnco_tb.m
%
% Description : The following Matlab testbench excercises the NCO model mnco_model.m
...
[sin_out,cos_out] = mnco_model(phi_inc_i,phase_mod_i,freq_mod_i);
fid_s = fopen('fsin_o_mnco_matlab.txt','w');
fid_c = fopen('fcos_o_mnco_matlab.txt','w');
for i=1:N
  fprintf(fid_s,'%f\n',sin_out(i));
  fprintf(fid_c,'%f\n',cos_out(i));
end
