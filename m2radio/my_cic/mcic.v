...
// Retrieval info: <MEGACORE title="CIC"  version="13.1"  build="162"  iptb_version="1.3.0 Build 162"  format_version="120" >
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.CICModel"  active_core="mcic_cic" >
...
// Retrieval info:      <PRIVATE name = "Device Family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "Number of Stages" value="5"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "Rate Change Factor" value="200"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "Differential Delay" value="2"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "Input Bit Width" value="16"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "Output Bit Width" value="16"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "Number of interfaces" value="1"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "Output Rounding Option" value="1"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="mcic.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "greybox">
// Retrieval info:      <PRIVATE name = "filename" value="mcic_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
